...
if dataset == 'sysu':
    ...
    data_path = '/data/zhangyinyin/dataset/SYSU-MM01/'
    log_path = args.log_path + 'sysu_log/'
    test_mode = [1, 2] # thermal to visible
elif dataset =='regdb':
    data_path = '/Project0551/guoqing/zhangyinyin/Dataset/RegDB/'
...
def train(epoch, loss_log):
    ...
    for batch_idx, (input1, input2, label1, label2) in enumerate(trainloader):
        ...
        if args.method =='id':
            ...
            loss_tri5, batch_acc5 = criterion_tri(feat[5], labels)
            ...
            loss5 = loss5 + w_hc * loss_c5 +  0.8 * loss_tri5
...
#全局特征
        ...
        loss = (loss0 + loss1 + loss2 + loss3 + loss4 + loss5) / 6 + loss_tri + loss_id
        # loss.backward()
